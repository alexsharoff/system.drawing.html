    ...
    public class CssBox
    {
        ...
        public string BorderColor
        {
            ...
            set
            {
                ...
                MatchCollection colors = Parser.Match(Parser.CssColorsRegex, value);
        ...
        public string Border
        {
            ...
            { 
                ...
                string borderWidth = Parser.Search(Parser.CssBorderWidthRegex, value);
                string borderStyle = Parser.Search(Parser.CssBorderStyleRegex, value);
                string borderColor = Parser.Search(Parser.CssColorsRegex, value);
        ...
        public string CornerRadius
        {
            ...
            set 
            {
                MatchCollection r = Parser.Match(Parser.CssLengthRegex, value);
        ...
        public string Font
        {
            ...
            { 
                ...
                int mustBePos;
                string mustBe = Parser.Search(Parser.CssFontSizeAndLineHeightRegex, value, out mustBePos);
                ...
                if (!string.IsNullOrEmpty(mustBe))
                {
                    ...
                    string fontStyle = Parser.Search(Parser.CssFontVariantRegex, leftSide);
                    string fontVariant = Parser.Search(Parser.CssFontVariantRegex, leftSide);
                    string fontWeight = Parser.Search(Parser.CssFontWeightRegex, leftSide);

                    //Check for family on the right
                    string rightSide = value.Substring(mustBePos + mustBe.Length);
                    string fontFamily = rightSide.Trim(); //Parser.Search(Parser.CssFontFamilyRegex, rightSide); //TODO: Would this be right?
        ...
        public string FontSize
        {
            ...
            set 
            {
                string length = Parser.Search(Parser.CssLengthRegex, value);
        ...
        public float ActualBorderSpacingHorizontal
        {
            get 
            {
                ...
                {
                    MatchCollection matches = Parser.Match(Parser.CssLengthRegex, BorderSpacing);
        ...
        public virtual void MeasureBounds(Graphics g)
        {
                ...
                Display == CssConstants.None)
            {
                ...
                if (Display != CssConstants.TableCell)
                {
                    ...
                    float top =
                        (prevSibling == null ? ContainingBlock.Location.Y : 0) +
        ...
        private void MeasureWordSpacing(Graphics g)
        {
            ...
            {
                string len = Parser.Search(Parser.CssLengthRegex, WordSpacing);
